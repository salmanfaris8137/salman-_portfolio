...
form.on('submit', function (e) {
    ...
    $.ajax({
        url: 'message.php', // form action url
        ...
        error: function (e) {
            ...
            submit.html(submit.data('original-text'));// reset submit button text
            submit.removeAttr("disabled");
            submit.before('<div class="alert alert-danger alert-dismissible fade show" role="alert">An error occurred. Please try again later.<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>').fadeIn("slow");
        }
    });
});
